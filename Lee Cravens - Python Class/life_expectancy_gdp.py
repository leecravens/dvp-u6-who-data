...
No. The data set is different, although for the same countries. Interestingly, there doesn't appear to be a correlation.
...
plt.savefig("LifeExpactancyByCountry.png")
plt.show()
...
Zimbabwe clearly had the most change with regards to life expectancy. China appears to have had the most growth in GDP,
although USA has shown strong growth as well. 
...
plt.suptitle('GDP as a Function Life Expectancy by Country')
...
It appears that China moved the most along the X axis while Zimbabwe moved the most along the Y axis. This didn't
really strike me as suprising and I do feel like there might be a better way to express this data.
...
The United States has the highest GDP while Zimbabwe has the lowest.
...
Germany, Chile and the US all appear to have very high life expectancy while Zimbabwe has the lowest.
